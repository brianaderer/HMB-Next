    ...
    return (
        <>
            ...
            <StickyPortal targetId={clientId}>
                <div className={`group-[.collapsed]:hidden flex flex-row items-center gap-4 w-full pb-2 group-[.stickyContainer]:p-4 group-[.stickyContainer]:justify-center group-[.stickyContainer]:py-2 lg:group-[.stickyContainer]:py-4 group-[.stickyContainer]:w-full lg:p-4 bg-base-100 rounded-b-lg ${classes}`}>
