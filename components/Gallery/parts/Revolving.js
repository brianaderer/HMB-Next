    ...
    return (
        <div>
            ...
            <div className="relative my-8 ">
                <div ref={carouselRef} style={{ width: dynamicWidth !== null ? dynamicWidth : 'auto' }} className={`imageGallery flex flex-row gap-4 max-w-full ${galleryActive ? `xl:max-w-[125%] xl:translate-x-[-50%] xl:ml-[50%]` : `w-fit max-w-[100%]`} mx-auto drop-shadow-lg border-2 border-secondary/20 rounded-xl`}>
