    ...
    return (
        <>
            ...
            <div className={`relative w-full my-8 mx-auto ${className}`}>
                <div className={`flex flex-row justify-center gap-4 ${oversize ? `w-[110%] translate-x-[-50%] ml-[50%] ` : ''} items-stretch mx-auto ${background ? `bg-neutral border-2 border-secondary/20` : ''} rounded-lg drop-shadow-lg p-8`}>
