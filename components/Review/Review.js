...
const Review = props => {
    ...
    <div className={`m-auto h-full flex flex-row justify-center items-center w-5/6`}>
        <div className={`h-full py-2 lg:py-10 px-4 lg:px-[10%] flex-grow rounded-lg flex flex-col items-center justify-center drop-shadow-lg mx-4 lg:mx-10 gap-2 lg:gap-4`}>
