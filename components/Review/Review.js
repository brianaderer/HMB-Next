...
const Review = props => {
    ...
    <div className={`m-auto h-full flex flex-row justify-center items-center flex-shrink-0 w-full`}>
        <div className={`border border-accent h-full py-2 lg:py-10 px-4 lg:px-[10%] flex-grow rounded-lg flex flex-col items-center justify-center drop-shadow-lg mb-12 lg:mx-10 gap-2 lg:gap-4`}>
